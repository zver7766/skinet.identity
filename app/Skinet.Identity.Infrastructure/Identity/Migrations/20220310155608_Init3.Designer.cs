...
namespace Skinet.Identity.Infrastructure.Identity.Migrations
{
    ...
    [Migration("20220310155608_Init3")]
    partial class Init3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skinet.Identity.Domain.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Skinet.Identity.Domain.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Skinet.Identity.Domain.Entities.AppUser", b =>
                {
                    b.HasOne("Skinet.Identity.Domain.Entities.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId");
